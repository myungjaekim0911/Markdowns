...
```plaintext  
시퀀스 설정 > 색상 관리 > 출력 색상 공간과 작업 색상 공간을 모두 Rec.709로 바꿔주세요

제가 자료 영상을 핸드폰의 HDR 모드로 찍어버린 탓에, 추가적인 조정이 필요하게 되었습니다
미안해요, 몰라도 되는 내용이에요!
```
![작업 색공간 & 표시 색공간 SDR로 바꾸기](./images/8.png)
